-- NOTE:
-- File paths need to be edited. Search for $$PATH$$ and replace it 
-- with the path to the directory containing the extracted data files.
...
COPY public.CLIENTES (idcliente, cliente, estado, sexo) FROM 'C:\backupbancodados\2865.dat';
...
COPY public.CREDITO ("IDCREDITO", "Duracao", "HistoricoCredito", "Proposito", "Valor", "Investimentos", "Emprego", "TempoParcelamento", "EstadoCivil", "FiadorTerceiros", "ResidenciaDesde", "Idade", "OutrosFinanciamentos", "Habitacao", "EmprestimoExistente", "Profissao", "Dependentes", "SocioEmpresa", "Estrangeiro", "Status") FROM 'C:\backupbancodados\2866.dat';

-- Data for Name: EMPREGO; Type: TABLE DATA; Schema: public; Owner: postgres
--COPY public."EMPREGO" ("IDEMPREGO", "EMPREGO") FROM stdin;
COPY public.EMPREGO ("IDEMPREGO", "EMPREGO") FROM 'C:\backupbancodados\2858.dat';
...
COPY public.ESTADOCIVIL ("IDESTADOCIVIL", "ESTADOCIVIL") FROM 'C:\backupbancodados\2863.dat';

-- Data for Name: FIADOR; Type: TABLE DATA; Schema: public; Owner: postgres
--COPY public."FIADOR" ("IDFIADOR", "FIADOR") FROM stdin;
COPY public.FIADOR ("IDFIADOR", "FIADOR") FROM 'C:\backupbancodados\2861.dat';
...
COPY public.HABITACAO ("IDHABITACAO", "HABITACAO") FROM 'C:\backupbancodados\2857.dat';
...
COPY public.HISTORICO_CREDITO ("IDHISTCRED", "HISTORICO") FROM 'C:\backupbancodados\2855.dat';
...
COPY public.INVESTIMENTOS ("IDINVESTIMENTOS", "INVESTIMENTOS") FROM 'C:\backupbancodados\2860.dat';
...
COPY public.OUTROSFINANC ("IDOUTROSFINANC", "OUTROSFINANCIAMENTOS") FROM 'C:\backupbancodados\2862.dat';
...
COPY public.PROFISSAO ("IDPROFISSAO", "PROFISSAO") FROM 'C:\backupbancodados\2859.dat';
...
COPY public.PROPOSITO ("IDPROPOSITO", "PROPOSITO") FROM 'C:\backupbancodados\2856.dat';
